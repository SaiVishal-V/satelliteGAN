...
"""
    ...
    # Try to restore from the last saved checkpoint
    ...
    if ckpt and ckpt.model_checkpoint_path:
        ...
        # Extract epoch number from checkpoint filename (e.g., model-050.ckpt -> 50)
        checkpoint_file = os.path.basename(ckpt.model_checkpoint_path)
        try:
            start_epoch = int(checkpoint_file.split('-')[1].split('.')[0])
